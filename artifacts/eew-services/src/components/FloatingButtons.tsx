  ...
  return (
    <div className="fixed bottom-6 right-4 z-50 flex flex-col gap-3 items-end">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.93 }}
        className="w-13 h-13 sm:w-14 sm:h-14 bg-[#0c4a6e] rounded-full flex items-center justify-center shadow-xl"
        style={{ width: 52, height: 52, boxShadow: "0 4px 18px rgba(12,74,110,0.45)" }}
      >
      ...
      <motion.a
        ...
        style={{ width: 52, height: 52, background: "#25d366", boxShadow: "0 4px 20px rgba(37,211,102,0.5)" }}
      >
        {/* Pulse ring */}
        <span className="absolute inset-0 rounded-full bg-[#25d366] animate-ping opacity-30" />
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="white" className="w-7 h-7 relative z-10">
